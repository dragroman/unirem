        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Компания «Универсал Ремстрой» предлагает комплексный подход к
              отделке квартир, включающий все необходимые этапы от подготовки
              документации до финальной сдачи объекта. Ниже представлена
              подробная схема процесса строительно-монтажных работ.
            </p>
          </div>
        </div>
      </section>
