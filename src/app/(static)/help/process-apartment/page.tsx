        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Процесс строительно-монтажных работ требует точного выполнения
              всех этапов. Важно согласование с заказчиком, обеспечение качества
              на каждом этапе и соблюдение сроков выполнения. Компания
              &quot;Универсал ремстрой&quot; гарантирует профессиональный подход
              и высокое качество всех выполняемых работ.
            </p>
