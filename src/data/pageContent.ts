...
const pageContent: PageContentCollection = {
  ...
  servicesApartment: {
    ...
    image: "/images/services/American_1.jpg",
  ...
  about: {
    ...
    title: "О компании",
    description:
      'Компания "Универсал ремстрой" – это надежный партнер в сфере строительства и ремонта, предоставляющий полный комплекс услуг от разработки дизайн-проекта до финальных отделочных работ. Мы работаем на российском рынке с особым фокусом на Дальневосточный регион, постепенно расширяя географию своей деятельности и выходя на международный уровень.',
