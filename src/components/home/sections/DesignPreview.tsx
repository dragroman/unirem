...
const designStyles = [
  ...
  },
  {
    ...
    description:
      "Изысканное сочетание классики и современности в каждом элементе интерьера",
    image: "/images/services/apartment/Eu_1.jpg",
  },
  {
    title: "Итальянский стиль",
    description:
      "Роскошный интерьер с изысканной мебелью и неповторимым шармом",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Найдите вдохновение для вашего дома среди множества стилей
          </p>
        </div>
