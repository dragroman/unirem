            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">+7 (4212) 123-456</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">info@uniremstroi.ru</p>
                  <p className="text-gray-600">sales@uniremstroi.ru</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    г. Хабаровск, ул. Примерная, 123, офис 45
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Сб: 10:00 - 15:00 (по предварительной записи)
                  </p>
                </div>
              </div>
            </div>
            ...
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center h-full py-8 text-center">
                ...
                <p className="text-gray-600 max-w-md">
                  Ваша заявка успешно отправлена. Наши специалисты свяжутся с
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="apartment">Ремонт квартиры</SelectItem>
                      <SelectItem value="house">Ремонт дома</SelectItem>
                      <SelectItem value="office">Ремонт офиса</SelectItem>
                ...
                <Button
                  type="submit"
                  className="w-full bg-emerald-700 hover:bg-emerald-600 text-white py-6"
                >
                  Отправить заявку
                </Button>
              </form>
